...
class PPO:
    ...
    def load_model(self, path):
        self.policy.load_state_dict(torch.load(path + '_pocicy', map_location=torch.device('cpu')))
        self.policy_old.load_state_dict(torch.load(path + '_policy_old', map_location=torch.device('cpu')))
